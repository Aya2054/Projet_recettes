        ...
        <div>
            <div>
                ...
                <div class="ingredient-container">
                    ...
                    <div class="ingredient-input">
                        <input list="list-ingredient" name="ingredients[0][name]" placeholder="Nom de l'ingrédient">
...
<script>
    ...
    <div class="ingredient-input">
      <input type="text" name="ingredients[][quantity]" placeholder="Quantité">
    </div>
    <div class="ingredient-input">
      <input type="text" name="ingredients[][name]" placeholder="Nom de l'ingrédient">
    </div>
    <div class="ingredient-image">
      <input type="file" name="ingredients[][image]" accept="image/*">
    </div>
  `;
